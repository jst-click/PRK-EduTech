...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AllNotesPageBooks(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class AllNotesPageBooks extends StatefulWidget {
  @override
  _AllNotesPageBooksState createState() => _AllNotesPageBooksState();
}

class _AllNotesPageBooksState extends State<AllNotesPageBooks> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // Set selectedCategory to 'notes' to only show ebooks
